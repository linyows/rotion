...
export type GalleryUrlProps = {
  payload: string|null
}

export const GalleryUrlField: React.FC<GalleryUrlProps> = ({ payload }) => {
  if (payload === null) {
    return (<></>)
  }
  ...
  return (
    <div className="notionate-gallery-url">
      <a className="notionate-gallery-url-a" href={payload} rel="noreferrer" target="_blank">
        <svg className="notionate-gallery-url-chain" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        ...
        <span className="notionate-gallery-url-address">
          {domain}
        </span>
      </a>
    </div>
