...
export const ListUrlField: React.FC<ListUrlProps> = ({ payload }) => {
  if (payload === null) {
    return (<></>)
  }
  ...
  return (
    <div className="notionate-list-url">
      <a className="notionate-list-url-a" href={payload} rel="noreferrer" target="_blank">
        <svg className="notionate-list-url-chain" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        ...
        <span className="notionate-list-url-address">
          {domain}
        </span>
      </a>
    </div>
