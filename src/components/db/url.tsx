...
export type DBUrlProps = {
  payload: string|null
}

export const DBUrlField: React.FC<DBUrlProps> = ({ payload }) => {
  if (payload === null) {
    return (<></>)
  }
  ...
  return (
    <div className="notionate-db-url">
      <a className="notionate-db-url-a" href={payload} rel={"noreferrer"} target={"_blank"}>
        <svg className="notionate-db-url-chain" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        ...
        <span className="notionate-db-url-address">
          {domain}
        </span>
      </a>
    </div>
