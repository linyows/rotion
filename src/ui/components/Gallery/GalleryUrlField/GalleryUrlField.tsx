...
const GalleryUrlField = ({ payload }: GalleryUrlFieldProps) => {
  ...
  return (
    <div className="rotion-gallery-url">
      <a className="rotion-gallery-url-link" href={payload} rel="noreferrer" target="_blank">
        <svg className="rotion-gallery-url-chain" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        ...
        <span className="rotion-gallery-url-domain">
          {domain}
        </span>
        <span className="rotion-gallery-url-path">
          {omittedPath}
        </span>
      </a>
    </div>
