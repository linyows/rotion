...
const PageIcon = ({ name, width, height, className }: PageIconProps) => {
  switch (name) {
    ...
    case 'github':
      return (
        <svg className={`rotion-icons-github ${className} ${Stylex(style.github)}`} version="1.0" xmlns="http://www.w3.org/2000/svg" width={width || '20px'} height={height || '20px'} viewBox="0 0 200 200" preserveAspectRatio="xMidYMid meet">
    ...
    case 'file':
      return (
        <svg className={`rotion-icons-file ${className} ${Stylex(style.file)}`} width={width || '20px'} height={height || '20px'} viewBox="0 0 16 16">
