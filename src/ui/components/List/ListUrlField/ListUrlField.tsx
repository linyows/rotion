...
const ListUrlField = ({ url }: ListUrlFieldProps) => {
  ...
  return (
    <div className="rotion-list-url">
      <a className="rotion-list-url-link" href={url} rel="noreferrer" target="_blank">
        <svg
          className="rotion-list-url-chain"
          width="16"
          height="16"
          viewBox="0 0 16 16"
        ...
        <span className="rotion-list-url-domain">{domain}</span>
        <span className="rotion-list-url-path">{omittedPath}</span>
      </a>
    </div>
  )
}
