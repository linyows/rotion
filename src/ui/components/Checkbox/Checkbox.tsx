  ...
  return (
    <div className="rotion-checkbox-checked">
      <div className="rotion-checkbox-checked-inner">
        <svg className="rotion-checkbox-checked-checkbox" viewBox="0 0 14 14" role="img" aria-hidden="true">
...
const UncheckedBox = () => {
  return (
    <div className="rotion-checkbox-unchecked">
      <svg className="rotion-checkbox-unchecked-checkbox" viewBox="0 0 16 16" role="img" aria-hidden="true">
