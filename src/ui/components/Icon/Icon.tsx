...
const Icon = ({ name, width, height, className }: IconProps) => {
  switch (name) {
    case 'figma':
      return (
        <svg className={`rotion-icon-figma ${className}`} version="1.0" xmlns="http://www.w3.org/2000/svg" width={width || '12px'} height={height || '18px'} viewBox="0 0 200 300">
    ...
    case 'slack':
      return (
        <svg className={`rotion-icon-slack ${className}`} version="1.0" xmlns="http://www.w3.org/2000/svg" width={width || '20px'} height={height || '20px'} viewBox="0 0 140 140">
    ...
    case 'github':
      return (
        <svg className={`rotion-icon-github ${className}`} version="1.0" xmlns="http://www.w3.org/2000/svg" width={width || '20px'} height={height || '20px'} viewBox="0 0 200 200" preserveAspectRatio="xMidYMid meet">
    ...
    case 'file':
      return (
        <svg className={`rotion-icon-file ${className}`} width={width || '20px'} height={height || '20px'} viewBox="0 0 16 16">
