...
description: Rotion draws Notion pages and databases with React components and builds them into a website, static or server-rendered.
---
...
>
  <Lede>
    ...
    site builds to plain static HTML or renders on a server. The page and the
    database shown here were fetched from Notion and drawn by Rotion when this
    page was built.
  </Lede>
  <Actions>
...
```mermaid
%%{init: {'layout': 'dagre', 'look': 'classic', 'theme': 'base', 'themeVariables': {'fontFamily': 'var(--font-sans), var(--font-jp), sans-serif', 'fontSize': '15px', 'primaryColor': '#fcf9f0', 'primaryTextColor': '#3d1a1f', 'primaryBorderColor': '#6a2730', 'lineColor': '#6a2730', 'edgeLabelBackground': '#fcf9f0', 'titleColor': '#6a2730'}}}%%
flowchart LR
  subgraph N ["Notion"]
  ...
  subgraph B ["Your site"]
    html["HTML<br/>static or on a server"]
  end
